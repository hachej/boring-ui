...
describe("QuestionsBridge", () => {
  ...
  // Inverted deliberately for #1348: a restart drops the in-process waiter, and the
  // bridge used to 409 the owner's answer instead of recording the decision.
  it("accepts submit when the runtime waiter is gone (#1348)", async () => {
