...
const items: TaskAttentionItem[] = [
  { id: "q1", title: "Choose region", kind: "question", agentTypeId: "alpha", sessionId: "native-1", createdAt: new Date().toISOString(), blocker: { id: "q1", reason: "question" } },
  { id: "q2", title: "Approve release", kind: "approval", agentTypeId: "alpha", sessionId: "native-2", blocker: { id: "q2", reason: "approval" } },
]
...
describe("TaskAttentionDisclosure", () => {
  it("renders a calm count and opens exact Inbox/chat only after explicit expansion", async () => {
    ...
    expect(capabilities.openDetachedChat).toHaveBeenCalledWith({ agentTypeId: "alpha", sessionId: "native-2" }, { title: "Approve release" })
  })
