...
export type TaskToolBindingErrorCode = "TASK_TOOL_CONTEXT_UNAVAILABLE" | "TASK_TOOL_FORBIDDEN"
  ...
  return {
    async resolve(ctx) {
      ...
      try {
        ...
        throw new TaskToolBindingError("TASK_TOOL_FORBIDDEN", "Task tool access is forbidden.")
      }
    },
  }
}
