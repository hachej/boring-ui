...
export const D1HostErrorCode = {
  ...
  BINDING_ADMITTED: 'D1_BINDING_ADMITTED',
  ACTIVE_BINDING_RESTART_REQUIRED: 'D1_ACTIVE_BINDING_RESTART_REQUIRED',
  SECRET_UNAVAILABLE: 'D1_SECRET_UNAVAILABLE',
  COLLECTION_LIMIT_EXCEEDED: 'D1_COLLECTION_LIMIT_EXCEEDED',
  ...
  ADMISSION_IDENTITY_MISMATCH: 'D1_ADMISSION_IDENTITY_MISMATCH',
  ADMISSION_RECORD_FAILED: 'D1_ADMISSION_RECORD_FAILED',
  ROLLBACK_JOURNAL_FAILED: 'D1_ROLLBACK_JOURNAL_FAILED',
  PROOF_INVALID: 'D1_PROOF_INVALID',
} as const
