...
import { assertD1ExactKeys as exactKeys, d1Digest as digest, invalidD1Field as fail, strictD1Ref as ref, type D1SiteBindingV1 } from './d1Plan.js'

export interface D1RuntimeInputsAttestationV1 {
...
export interface D1RuntimeInputsIdentityV1 {
  readonly schemaVersion: 1
  readonly domain: 'boring-d1-runtime-inputs:v1'
...
const DOMAIN = 'boring-d1-runtime-inputs:v1' as const
...
function parseAttestation(raw: unknown, desired: D1SiteBindingV1): D1RuntimeInputsAttestationV1 {
...
export async function createD1RuntimeInputsIdentity(
  desired: D1SiteBindingV1,
  rawAttestation: D1RuntimeInputsAttestationV1,
): Promise<D1RuntimeInputsIdentityV1> {
...
export async function canonicalizeD1RuntimeInputsIdentity(raw: unknown, desired: D1SiteBindingV1): Promise<D1RuntimeInputsIdentityV1> {
  ...
  const expected = await createD1RuntimeInputsIdentity(desired, {
