...
/**
 * Verifies that ChatCenteredShell's two resize handles (sessions drawer +
...
test.describe("ChatCenteredShell resize", () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.evaluate(
      ...
      [DRAWER_KEY, SURFACE_KEY, `${STORAGE_KEY}:drawer`, `${STORAGE_KEY}:surface`],
    )
    await page.reload()
