...
Read [ONE-CHAT.md](ONE-CHAT.md) first: it says how to run this method inside a single chat, where the only artifact is one intent file and the user never sees the method.
