...
export const workspaceCommandPaletteSpec: UiReviewSpec = {
  ...
  target: {
    ...
    defaultPort: 5380,
    defaultApiPort: 5390,
    serverEnvironmentKeys: ["PORT", "AGENT_API_PORT", "BORING_AGENT_WORKSPACE_ROOT", "BORING_AGENT_SESSION_ROOT", "BORING_WORKSPACE_PLAYGROUND_NATIVE_SESSION_START", "VITE_HMR_HOST", "VITE_HMR_CLIENT_PORT"],
    environment: ({ isolation, port, apiPort }) => ({
      ...
      BORING_WORKSPACE_PLAYGROUND_NATIVE_SESSION_START: "0",
