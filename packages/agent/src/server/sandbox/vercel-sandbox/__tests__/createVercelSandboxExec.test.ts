  ...
  expect(runCommand).toHaveBeenCalledWith(
    expect.objectContaining({
      ...
      env: expect.objectContaining({
        ...
        PATH: '/workspace/.boring-agent/node/node_modules/.bin:/workspace/.boring-agent/venv/bin:/workspace/.boring-agent/sdk/uv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin',
      }),
    }),
  )
})
  ...
  expect(runCommand).toHaveBeenCalledWith(
    expect.objectContaining({
      ...
      env: {
        ...
        EXAMPLE_API_URL: 'https://api.example.test/workspace',
        HOME: '/workspace',
        PATH: '/workspace/.boring-agent/node/node_modules/.bin:/workspace/.boring-agent/venv/bin:/workspace/.boring-agent/sdk/uv/bin:/plugin/bin:/workspace/.boring-agent/bin:/usr/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin',
        VIRTUAL_ENV: '/workspace/.boring-agent/venv',
      },
    }),
  )
