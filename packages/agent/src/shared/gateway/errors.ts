...
export const AgentGatewayErrorCode = {
  ...
  AGENT_ENTITLEMENT_REQUIRED: 'AGENT_ENTITLEMENT_REQUIRED',
  AGENT_ACCESS_FORBIDDEN: 'AGENT_ACCESS_FORBIDDEN',
  AGENT_ACCESS_POLICY_UNAVAILABLE: 'AGENT_ACCESS_POLICY_UNAVAILABLE',
  ...
  AGENT_ACCEPTED_WORK_UNAVAILABLE: 'AGENT_ACCEPTED_WORK_UNAVAILABLE',
  AGENT_RUNTIME_RESTART_REQUIRED: 'AGENT_RUNTIME_RESTART_REQUIRED',
