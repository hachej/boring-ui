...
const EXPECTED_ERROR_CODES = [
  ...
  'SANDBOX_LEASE_NOT_FOUND',
  'SANDBOX_LEASE_EXPIRED',
  'SANDBOX_LEASE_DRAINING',
  'SANDBOX_LEASE_QUOTA_EXCEEDED',
  'SANDBOX_LEASE_CREATION_ABORTED',
  'SANDBOX_LEASE_DRAIN_TIMEOUT',
  'SANDBOX_LEASE_CLEANUP_FAILED',
  'SANDBOX_LEASE_SERVICE_CLOSED',
  'SANDBOX_TARGET_INVALID',
  'SANDBOX_TARGET_FAILED',
  'VERCEL_API_ERROR',
  'BLAXEL_API_ERROR',
  'BLAXEL_CONFIG_DRIFT',
