export const CREDENTIAL_ERROR_CODES = {
  ...
  KEK_UNAVAILABLE: "CREDENTIAL_KEK_UNAVAILABLE",
  ...
  VALIDATION_UNAUTHORIZED: "CREDENTIAL_VALIDATION_UNAUTHORIZED",
  VALIDATION_RATE_LIMITED: "CREDENTIAL_VALIDATION_RATE_LIMITED",
  VALIDATION_UNAVAILABLE: "CREDENTIAL_VALIDATION_UNAVAILABLE",
  VALIDATION_TIMEOUT: "CREDENTIAL_VALIDATION_TIMEOUT",
  VALIDATION_UNSUPPORTED: "CREDENTIAL_VALIDATION_UNSUPPORTED",
} as const
