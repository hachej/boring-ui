...
export function createVercelSandboxRuntimeDescriptor(
  providerOptions: VercelSandboxProviderOptions = {},
): SandboxRuntimeModeDescriptorV1 {
...
export const vercelSandboxRuntimeDescriptor = createVercelSandboxRuntimeDescriptor()
