...
// source of truth for every build path, including the explicit Docker no-DTS
// build, so a new shipped stylesheet is added in one place.
const CSS_ASSETS = [
  'front/theme.css',
...
export default defineConfig({
  ...
  // break React Email templates authored for the automatic runtime.
