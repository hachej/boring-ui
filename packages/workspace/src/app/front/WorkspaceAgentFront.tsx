...
>({
  ...
  const managementActions = useMemo<WorkspaceAgentAppLeftAction[]>(() => {
    const actions: WorkspaceAgentAppLeftAction[] = [...pluginPrimaryActions, ...(appLeftActions ?? [])]
    ...
    return actions
  }, [appLeftActions, pluginPrimaryActions, pluginsActionEnabled, skillsActionEnabled])
