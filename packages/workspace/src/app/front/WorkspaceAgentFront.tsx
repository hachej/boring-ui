...
>({
  ...
  const remoteSessionsEnabled = provisionWorkspace !== false && workspaceWarmupStatus.status === "ready"
  ...
  const remoteSessionsPending = shouldUseRemoteSessions && provisionWorkspace !== false && !remoteSessionsEnabled
  ...
  const remoteSessionApi = useSessions({
    ...
    enabled: shouldUseRemoteSessions && remoteSessionsEnabled,
  })
  const sessionApi = shouldUseRemoteSessions && remoteSessionsEnabled ? remoteSessionApi : undefined
  ...
  const hydrateMessages = provisionWorkspace !== false && (
    shouldUseRemoteSessions ? remoteSessionsEnabled && Boolean(resolvedActiveId) : true
  )
