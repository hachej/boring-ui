...
import { inboxDetailPanel, inboxPreviewPanel, WorkspaceInboxShellProvider, type WorkspaceInboxShellApi } from "../../plugins/inboxPlugin/front"
...
export function useWorkspaceInboxHost({
  ...
  const providerPanels = useMemo(
    () => enabled ? [...(panels ?? []), inboxPreviewPanel, inboxDetailPanel] : panels,
    [enabled, panels],
  )
