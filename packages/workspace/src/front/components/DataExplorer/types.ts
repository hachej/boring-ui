...
//
// Generic primitive for browsing flat lists of things (series, tables, PRs,
// agent runs, …). Async adapter contract; the explorer never assumes the
// dataset fits in memory. Hierarchical and streaming use cases are out of
// scope (see CLAUDE.md notes).
// ---------------------------------------------------------------------------
