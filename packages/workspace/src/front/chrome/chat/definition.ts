...
type ChatPaneParams = (Partial<WorkspaceChatPanelProps> & ChatPanelHostShellProps & { debug?: boolean; viewId?: string }) | undefined
...
function ChatPane({ params }: PaneProps<ChatPaneParams>) {
  ...
  return createElement(ChatPanelHost, { key: params.viewId ?? params.sessionId, debug: params.debug, ...params, sessionId: params.sessionId })
}
