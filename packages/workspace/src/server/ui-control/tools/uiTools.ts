...
export function createExecUiTool(
  ...
  return {
    ...
    description: [
      ...
      "file or the final focus. exec_ui cannot present multiple files at once;",
      "do not claim that chat recognizes arbitrary @path text, and do not use",
      "repeated openFile calls as a plural presentation mechanism.",
      "",
