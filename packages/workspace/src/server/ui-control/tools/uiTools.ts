...
export function createExecUiTool(
  ...
  return {
    ...
    description: [
      ...
      "file or the final focus. To present multiple deliverables, use an",
      "existing structured plural HumanArtifact list, including ask_user",
      "artifacts[], supplied by the active tool or workflow; register every",
      "deliverable. Do not",
      "claim that chat automatically recognizes arbitrary @path text, and do",
      "not use repeated openFile calls as a plural presentation mechanism.",
      "",
