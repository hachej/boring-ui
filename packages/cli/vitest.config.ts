...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^@hachej\/boring-automation\/front\/descriptor$/, replacement: resolve(repoRoot, "plugins/boring-automation/src/front/descriptor.tsx") },
      ...
      { find: /^@hachej\/boring-tasks\/front\/descriptor$/, replacement: resolve(repoRoot, "plugins/tasks/src/front/descriptor.tsx") },
