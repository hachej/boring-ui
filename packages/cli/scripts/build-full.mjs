/**
 * Full CLI build: package deps → runtime modes → default plugins → CLI frontend → public/ → tsup compile.
...
console.log("2/6  building boring-bash package…")
run("pnpm --filter @hachej/boring-bash build", resolve(__dirname, "../../.."))

console.log("3/6  building workspace package…")
