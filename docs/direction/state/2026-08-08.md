...
[`../VISION.md`](../VISION.md) (living vision; frozen #391 plan-pack copy at [`../../issues/391/runtime-refactor/VISION.md`](../../issues/391/runtime-refactor/VISION.md)),
...
> **Errata (2026-08-08, post-grill ratifications — supersede the wording
> below):**
> - **Terminology:** "vertical agent" is the semantic standard
>   ([`DIRECTION.md` §Vertical agents](../DIRECTION.md#vertical-agents--the-semantic-standard-ratified-2026-08-08)).
>   This snapshot's "niche agent" reads as *vertical agent*; its "influencer
>   agent" is a vertical agent whose niche is a person/brand. The §6
>   influencer gap list is re-labeled **public-vertical-agent features**
>   (self-signup, spend caps/abuse guardrails, channels). The surviving
>   distinction is audience: private (invite-only, operational today) vs
>   public (open registration; requires that gap list). Every agent launches
>   private; going public is a per-hostname ops decision once caps exist.
> - **Metering:** §3/§4's recommendation is amended by
>   [`DIRECTION.md` §Commercial premises](../DIRECTION.md#commercial-premises-ratified-2026-08-08):
>   the platform emits usage facts only when a usage-priced offer pulls it,
>   apps own billing — #819 is NOT a blocker for the first vertical agent
>   under subscription pricing.
> - **Lanes:** §2's ranking is amended: #1123 exec-envs is ACTIVE at LOW
>   priority (not parked); #1127 channels deprioritized; UI polish is a
>   standing low-effort background loop. #1107 slice 3 (workspace
>   install/update path) is queued next in the agent-packaging lane, below
>   landing/BYOK.
