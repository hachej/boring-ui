...
> **Errata (2026-08-08):** the metering recommendation in §3/§4 is amended by
> [`DIRECTION.md` §Commercial premises (ratified 2026-08-08)](../DIRECTION.md#commercial-premises-ratified-2026-08-08):
> the platform emits usage facts only when a usage-priced offer pulls it, apps
> own billing — #819 is NOT a blocker for the first niche agent under
