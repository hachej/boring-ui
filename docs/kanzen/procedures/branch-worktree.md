...
- Default branch: `codex/issue-<number>-<slug>`; if no issue exists, use
  `codex/<short-slug>`.
...
git switch -c codex/issue-123-short-slug
```

For an isolated worktree:

```bash
git worktree add ../boring-ui-v2-issue-123 -b codex/issue-123-short-slug main
