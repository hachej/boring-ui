...
> `provisioningFingerprint`, is a narrower Host-internal runtime-placement
...
> [Status 2026-07-27: shipped in v0.1.91 — see `docs/issues/909/plan.md`.
> This surface is occupied: the shipped `EmbeddedAgentGateway` plus the
> `connectSession` connection object is this seam. Any remaining
> invocation-shaped need must build behind the shipped Gateway, not beside it.]
