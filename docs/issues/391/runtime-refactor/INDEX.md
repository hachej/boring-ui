...
> [Status 2026-07-27: the agent construction/session funnel shown as F3 below
> shipped in v0.1.91 as `createAgentHost()` and `AgentGateway`; Decision 28's
> remaining scope is Environment file/exec governance and Workspace
> orchestration. See `docs/issues/909/plan.md`.]
