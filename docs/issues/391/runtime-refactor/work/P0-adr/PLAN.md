...
- [08-pluggable-agent-surfaces.md](../../architecture/08-pluggable-agent-surfaces.md) — the 10 locked decisions + the four-part surface contract + north star this phase records into `docs/DECISIONS.md`.
