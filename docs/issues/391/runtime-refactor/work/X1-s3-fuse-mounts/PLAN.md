...
- [09-environments-attachable.md](../../architecture/09-environments-attachable.md) — attachments, host-owned auth-gated contributions, methodless facts, host-supplied `mountPath`, and no-leak conformance.
