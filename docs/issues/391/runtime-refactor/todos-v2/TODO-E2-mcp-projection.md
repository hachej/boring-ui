...
Match `06-migration-phases.md` Phase E2 exit criteria:
...
### BBE2-003 — No-leak conformance as the fourth mount (M)
...
pnpm --filter @hachej/boring-bash run test        # vitest run — includes the four conformance mounts
