...
- **Every prior phase** of this pack **except P6b** (P1–P7, T1–T2, E1–E2, S1–S3, Phase 5, **P6a**). S3 is in the epic (VISION-MAP row 6 — workspace-as-control-plane — requires it), so P8 gates on it. P8 is the terminal gate. It **must not** land while any earlier phase's `TODO(remove:*)` marker is still live — that reopens the owning phase (see "The rule", below).
