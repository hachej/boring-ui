...
| 4 | D1-004a3a -> a3b -> a4a/a4b -> b1/b2 -> c/d -> D1-005 -> D1-006 | **priority 1; D1-004a4a/#694 and a4b/#695 landed; D1-004b1 active** | Land workspace/signup and destructive authority fences, selector/admission fences, atomic N-binding boot, then the three-agent EU proof. |
...
| D1-004b1 — workspace authority/signup — **ACTIVE** | request-workspace helper; `workspaces.ts`, member guard, auth proxy/composition, `postSignupHook.ts`, errors/tests | <= 400 net lines; 30 min | foreign path 421 before stores; membership before lookup; one bound list; create/delete/default provisioning denied; auth proxy strips caller scope and installs trusted scope; post-signup invite only for exact bound workspace; generic mode unchanged |
| D1-004b2 — destructive ownership/account guards | `members.ts`, account routes, focused tests | <= 250 net lines; 25 min | deny every scoped existing-owner demotion/removal/account deletion; preserve non-owner account deletion, editor/viewer removal, owner add/promotion, and generic behavior |
...
**D1 total: 15 dispatch units (D1-001…003; D1-004a1, a2, a3a, a3b, a4a, a4b, b1, b2, c, d;
D1-005; D1-006) per the accepted D1-R0 contract and its reality recut.**
D1-001…004a4b are landed, D1-004b1 is active, and the remaining units are ordered.
...
P1 readiness (#642), P6-R (#647), D1-R0 (#649), and D1-001 through D1-004a4b
(#652–#654, #660, #662, #665, #667, #672, #675–#680, #684, #685, #690, #692, #694, #695) are landed. D1-004b1 is the active priority-1 slice. P2 recut #641
