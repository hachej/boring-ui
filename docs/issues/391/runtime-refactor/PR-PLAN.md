...
| 4 | D1-004a3a -> a3b -> a4a/a4b -> b/c/d -> D1-005 -> D1-006 | **priority 1; D1-004a3b landed #692; D1-004a4a active** | Land bounded landing, production activation/readiness, authority/admission fences, atomic N-binding boot, then the three-agent EU proof. |
...
| D1-004a4a — landing/root seam — **ACTIVE** | bounded `d1Landing.ts`; narrow optional core root-handler seam; focused tests | <= 400 net lines; 25 min | revalidated/escaped bounded landing, fixed same-origin auth return, drift/read failure redacted 503, authenticated root delegates to unchanged SPA; no production activation or public internal ids |
| D1-004a4b — readiness/production activation | `d1ServerWiring.ts`, `d1Readiness.ts`; small host-scope/core type changes; literal-IPv4 Compose health probe/topology proof; `main.ts`; focused tests | <= 400 net lines; 25 min | owner UID from process-level `core.env`; exact owner/process/proxy inputs; one shared reader; raw-`127.0.0.1` exact health/readiness bypass only; health works before active while readiness is redacted 503; D1 wiring enabled before other effects; generic mode unchanged |
...
**D1 total: 14 dispatch units (D1-001…003; D1-004a1, a2, a3a, a3b, a4a, a4b, b, c, d;
D1-005; D1-006) per the accepted D1-R0 contract and its reality recut.**
D1-001…004a3b are landed, D1-004a4a is active, and the remaining units are ordered.
...
P1 readiness (#642), P6-R (#647), D1-R0 (#649), and D1-001 through D1-004a3b
(#652–#654, #660, #662, #665, #667, #672, #675–#680, #684, #685, #690, #692) are landed. D1-004a4a is the active priority-1 slice. P2 recut #641
