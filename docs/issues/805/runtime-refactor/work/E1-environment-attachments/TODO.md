...
- Plan: `docs/issues/805/plan.md` § "Phase E1" (deliverables + exit criteria) and § "Rules" (rule 4: #416 landed contracts must not be redone).
...
Matches [`../../PR-PLAN.md`](../../../../391/runtime-refactor/PR-PLAN.md) E1 rows exactly:
