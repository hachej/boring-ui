...
[`P5A-HANDOFF.md`](P5A-HANDOFF.md), not this aggregate closeout.

Derived strictly from [TODO.md](TODO.md) and [PLAN.md](PLAN.md). Tick each before calling this package done. Invent nothing.

## Prerequisites (packages + gates)
- [ ] P3-routes-tools merged — [../P3-routes-tools/HANDOFF.md](../P3-routes-tools/HANDOFF.md)
- [ ] E1 host-owned attachment lifetime merged — [../E1-environment-attachments/HANDOFF.md](../E1-environment-attachments/HANDOFF.md)
- [ ] P2 `@hachej/boring-sandbox/providers` + `@hachej/boring-sandbox/shared` `ProviderCapabilities` / `providerMatrix` present (concrete post-P2 file: `packages/boring-sandbox/src/shared/providerMatrix.ts`; or STOP+report) — [../P2-sandbox-providers/HANDOFF.md](../../../../808/runtime-refactor/work/P2-sandbox-providers/HANDOFF.md)

## Owner questions / verdict
- OWNER-QUESTIONS: none.
- GO/NO-GO: GO after P2, P3, and E1 prerequisites above are true; NO-GO/STOP if
  the provider matrix/runsc path, bash bundle/routes, or auth-gated attachment
  lifetime is absent.
...
- [ ] BBP5-008 — Authenticated remote-worker hardening handshake
...
- [ ] BBP5-010 — Remote-worker no-leak conformance mount
...
- [ ] `pr2-extract-engine-repoint-callers` completed BBP5-002
...
- [ ] `pr7-authenticated-worker-handshake` completed BBP5-008
- [ ] `pr7b-remote-worker-attachment-mount` completed BBP5-010
...
## Review gates
- [ ] P2 provider matrix/runsc, P3 bash bundle/routes, and E1 auth-gated
      attachment lifetime confirmed (or STOP+report). P5 may run alongside P4,
      never ahead of E1.
- [ ] `pnpm lint:invariants` + `pnpm audit:imports` green; zero agent→bash value imports; operational engine/runners moved to boring-bash/server with no agent compatibility export.
...
- [ ] Remote-worker handshake authenticates/freshness-binds the worker, reports
      typed `reported|unknown` runsc/network/limit facts, matches the real target,
      and fails closed on unknown/stale/replay.
