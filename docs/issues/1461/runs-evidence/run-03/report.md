...
- Exploration desktop: 9/50 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=34, state-limit=7
- Exploration mobile: 9/47 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=32, state-limit=6
