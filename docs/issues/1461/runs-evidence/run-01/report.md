...
- Exploration desktop: 9/55 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=42, state-limit=4
- Exploration mobile: 9/55 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=31, state-limit=15
