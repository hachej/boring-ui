...
- Exploration desktop: 9/49 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=31, state-limit=9
- Exploration mobile: 9/50 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=37, state-limit=4
