...
- Exploration desktop: 9/38 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=21, state-limit=8
- Exploration mobile: 9/50 selected; 0 raw violation state(s)
  - Overflow: duplicate-visual-state=32, state-limit=9
