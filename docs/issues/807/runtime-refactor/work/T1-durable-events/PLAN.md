...
- [08-pluggable-agent-surfaces.md](../../../../391/runtime-refactor/architecture/08-pluggable-agent-surfaces.md) — the event-stream contract, human-in-the-loop, two-handles, and conformance sections; the locked Durable Streams wire-protocol decision this phase implements.
