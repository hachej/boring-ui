...
Revisions: authoritative base/current main `68dcb7db8822f721c6b45d0731e01a46fa364f28` → final code `2f59627f79b1d5ecec81f0fc2df7b62fb8894474` (stale-lock predecessor `20c13de549a5871c09622bc93b66a77871510f20`).
...
```diff
 ObjectivePane background poll / visibility refresh
-  transient bridge failure cleared the loaded Objective
+  keep the last loaded Objective visible
+  show the existing warning notice with the stable failure message
+  next successful refresh replaces the record and clears the warning
```
