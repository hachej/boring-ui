...
- `docs/issues/808/plan.md` — Phase 2 deliverables/exit; "Do not move providers until Phase 1 injection is complete."
...
- `packages/agent/src/server/runtime/mode.ts` — **type-only** contracts (`RuntimeModeAdapter`, `RuntimeBundle`, `RuntimeBashStrategy`, `RuntimeFilesystemStrategy`, `RuntimeFilesystemBinding`, `getRuntimeBundleStorageRoot`). These stay agent-side per [`../../architecture/00-global-isa.md`](../../../../391/runtime-refactor/architecture/00-global-isa.md) and [`../P1-headless-core/TODO.md`](../../../../805/runtime-refactor/work/P1-headless-core/TODO.md) until Phase 1 injection lands; only concrete adapters/`resolveMode()` move.
...
- **Precondition:** Phase 1 dependency injection (`createAgent()` / injected runtime+tools; see [`../P1-headless-core/TODO.md`](../../../../805/runtime-refactor/work/P1-headless-core/TODO.md)) is complete before providers move. If not, STOP and report — do not move providers.
