...
| Field | |
|---|---|
| **Status** | **Accepted (2026-07-11).** Landed via PR [#632](https://github.com/hachej/boring-ui/pull/632). |
...
| Field | |
|---|---|
| **Status** | **Owner-approved (2026-07-11); implementation pending.** This topology amendment must land with the reconciled #391 plan pack before P6-R/D1 dispatch. |
