...
- [`web/`](web/README.md) — human-oriented guide: architecture overview, full package map, getting started, composition guide, per-package explainers, glossary. Orientation, not normative spec — canonical specs live in `packages/*/docs/`.
