...
| `macos-desktop` | Private Electron Forge host that packages the local CLI server and existing SPA as a hardened macOS desktop application. | [README](../apps/macos-desktop/README.md) |
