...
| `data-catalog` | Builder (`createDataCatalogPlugin`) binding an adapter into a workspace page + visualization panel + catalog + surface resolver, plus a `query_data_catalog` agent tool. | [README](../plugins/data-catalog/README.md) |
