> **HISTORICAL — superseded 2026-09-07** by the consolidated edition at [`../README.md`](../README.md). Kept for the record; do not cite as current. This was the vision overview (2026-08-27 edition, amended through 2026-09-06).
...
The [software model](software-model-2026-09-06.md) contains the ownership map, source
