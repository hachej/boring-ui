...
# ---------------------------------------------------------------------------
# Reason codes — extensible profile (custom pane / tool / integration)
# ---------------------------------------------------------------------------

PANE_FILE_MISSING = "PANE_FILE_MISSING"
PANE_NO_DEFAULT_EXPORT = "PANE_NO_DEFAULT_EXPORT"
PANE_NOT_IN_CAPABILITIES = "PANE_NOT_IN_CAPABILITIES"
PANE_MISSING_EVAL_ID_REF = "PANE_MISSING_EVAL_ID_REF"
PANE_MISSING_BACKEND_CALL = "PANE_MISSING_BACKEND_CALL"
PANE_IMPORT_ERROR = "PANE_IMPORT_ERROR"

TOOL_ROUTER_FILE_MISSING = "TOOL_ROUTER_FILE_MISSING"
TOOL_NOT_IN_TOML = "TOOL_NOT_IN_TOML"
TOOL_LOCAL_UNREACHABLE = "TOOL_LOCAL_UNREACHABLE"
TOOL_LOCAL_INCORRECT = "TOOL_LOCAL_INCORRECT"
TOOL_LOCAL_SCHEMA_INVALID = "TOOL_LOCAL_SCHEMA_INVALID"
TOOL_INPUT_NOT_VARYING = "TOOL_INPUT_NOT_VARYING"
TOOL_LIVE_UNREACHABLE = "TOOL_LIVE_UNREACHABLE"
TOOL_LIVE_INCORRECT = "TOOL_LIVE_INCORRECT"
TOOL_LIVE_NONCE_MISMATCH = "TOOL_LIVE_NONCE_MISMATCH"
TOOL_NOT_IN_CAPABILITIES = "TOOL_NOT_IN_CAPABILITIES"

INTEG_PANE_NO_TOOL_CALL = "INTEG_PANE_NO_TOOL_CALL"
INTEG_CONTRACT_MISMATCH = "INTEG_CONTRACT_MISMATCH"
INTEG_NONCE_MISMATCH = "INTEG_NONCE_MISMATCH"
...
DEFAULT_ATTRIBUTION: dict[str, Attribution] = {
    ...
    # Extensible profile — agent's responsibility
    PANE_FILE_MISSING: Attribution.AGENT,
    PANE_NO_DEFAULT_EXPORT: Attribution.AGENT,
    PANE_NOT_IN_CAPABILITIES: Attribution.AGENT,
    PANE_MISSING_EVAL_ID_REF: Attribution.AGENT,
    PANE_MISSING_BACKEND_CALL: Attribution.AGENT,
    PANE_IMPORT_ERROR: Attribution.AGENT,
    TOOL_ROUTER_FILE_MISSING: Attribution.AGENT,
    TOOL_NOT_IN_TOML: Attribution.AGENT,
    TOOL_LOCAL_UNREACHABLE: Attribution.MIXED,
    TOOL_LOCAL_INCORRECT: Attribution.AGENT,
    TOOL_LOCAL_SCHEMA_INVALID: Attribution.AGENT,
    TOOL_INPUT_NOT_VARYING: Attribution.AGENT,
    TOOL_LIVE_UNREACHABLE: Attribution.MIXED,
    TOOL_LIVE_INCORRECT: Attribution.AGENT,
    TOOL_LIVE_NONCE_MISMATCH: Attribution.AGENT,
    TOOL_NOT_IN_CAPABILITIES: Attribution.AGENT,
    INTEG_PANE_NO_TOOL_CALL: Attribution.AGENT,
    INTEG_CONTRACT_MISMATCH: Attribution.AGENT,
    INTEG_NONCE_MISMATCH: Attribution.AGENT,
