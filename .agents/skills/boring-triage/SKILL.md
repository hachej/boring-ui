...
| `proof` | follow `docs/procedures/proof-of-work.md` |
| `merge` | fast-track merge or `docs/procedures/owner-review-card.md` |
...
GitHub item. Use `docs/procedures/branch-worktree.md` for mechanics. Helpers
